...
<head>
  <?php $title = 'Origin Driving School'; ?>
  <meta charset="utf-8">
...
<body>
  ...
  <main>
    ...
    <section class="section">
      <div class="container">
        <h2>Why choose origin driving school</h2>

        <div class="grid-3">
          <div class="card--glass">
            <div class="item">
              <img class="thumb" src="assets/img/instructor.png" alt="Accredited Instructors">
              <div>
                <h3>Accredited Instructors</h3>
                <p>Patient, certified, professional driving instructors.</p>
              </div>
            </div>
          </div>
          ...
          <div class="card--glass">
            <div class="item">
              <img class="thumb" src="assets/img/car.png" alt="Auto & Manual">
              <div>
                <h3>Auto & Manual</h3>
                <p>Modern dual-control cars, both automatic and manual.</p>
              </div>
            </div>
          </div>
          ...
          <div class="card--glass">
            <div class="item">
              <img class="thumb" src="assets/img/schedule.png" alt="Flexible Scheduling">
              <div>
                <h3>Flexible Scheduling</h3>
                <p>Morning, evening, or weekend — we fit your calendar.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- COURSES -->
    <section class="course-pro">
      <h2 class="course-pro__heading">Our courses</h2>

      <div class="course-pro__grid">
        <!-- 1 -->
        <article class="course-pro__card">
          <div class="course-pro__media">
            <img src="assets/img/beginner.png" alt="Beginner Driving Lessons">
            <span class="course-pro__title">Beginner Driving Lessons</span>
          </div>
          <p class="course-pro__desc">
            Start strong with foundational training that builds confidence from day one.
          </p>
        </article>
        ...
        <article class="course-pro__card">
          <div class="course-pro__media">
            <img src="assets/img/test.png" alt="Road Test Preparation">
            <span class="course-pro__title">Road Test Preparation</span>
          </div>
          <p class="course-pro__desc">
            Focused practice on manoeuvres, signalling, and defensive driving.
          </p>
        </article>
        ...
        <article class="course-pro__card">
          <div class="course-pro__media">
            <img src="assets/img/refresher.png" alt="Adult Refresher Courses">
            <span class="course-pro__title">Adult Refresher Courses</span>
          </div>
          <p class="course-pro__desc">
            Personalised lessons designed for adults returning to the driver’s seat.
          </p>
        </article>
        ...
        <article class="course-pro__card">
          <div class="course-pro__media">
            <img src="assets/img/international.png" alt="Manual Transmission Training">
            <span class="course-pro__title">International driving</span>
          </div>
          <p class="course-pro__desc">
            Drive abroad confidently with our International Driver’s License today. Get your International Driver’s Permit fast, safe, and secure.
          </p>
        </article>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <ul class="testimonial-list">
          ...
          <li class="testimonial-card">
            <img class="testimonial-photo" src="assets/img/student1.jpg" alt="student photo">
            <div class="testimonial-content">
              <div class="stars" aria-label=" 5 stars">
                <span>★</span><span>★</span><span>★</span><span>★</span><span>★</span>
              </div>
              <blockquote>“Passed first go! Great instructors.”</blockquote>
              <cite>Mia</cite>
            </div>
          </li>
          ...
          <!-- Card 2 -->
          <li class="testimonial-card">
            <img class="testimonial-photo" src="assets/img/student2.jpg" alt="student photo">
            <div class="testimonial-content">
              <div class="stars" aria-label="5 stars">
                <span>★</span><span>★</span><span>★</span><span>★</span><span>★</span>
              </div>
              <blockquote>“Flexible times and supportive.”</blockquote>
              <cite>Liam</cite>
            </div>
          </li>
          ...
          <!-- Card 3 -->
          <li class="testimonial-card">
            <img class="testimonial-photo" src="assets/img/student3.jpg" alt="student photo">
            <div class="testimonial-content">
              <div class="stars" aria-label=" 5 stars">
                <span>★</span><span>★</span><span>★</span><span>★</span><span>★</span>
              </div>
              <blockquote>“Mock tests made the real one easy.”</blockquote>
              <cite>Noor</cite>
            </div>
          </li>
        </ul>
